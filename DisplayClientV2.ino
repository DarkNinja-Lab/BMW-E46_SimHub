...
#define DEVICE_NAME "e46 Cluster" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "f9a12bfc-ed07-4286-a0fa-aaa9dc68585a" //{"UniqueId":"f9a12bfc-ed07-4286-a0fa-aaa9dc68585a","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
